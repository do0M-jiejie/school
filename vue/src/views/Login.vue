<template>
  <div class="login-container">
    <div style="color: #ae7f18; font-size: 50px; font-weight: bold; position: absolute; text-align: center; top: 50px">修炼健身管理系统</div>
    <div class="login-box">
...
.login-container {
  ...
  align-items: center;
  background-image: url("@/assets/LoginBackground3.jpg");
