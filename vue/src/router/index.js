  ...
  routes: [
    { path: '/', redirect: '/login' },
    {
      ...
      children: [
        ...
        { path: 'user_manager', name: 'user_manager', meta: { title: '用户' }, component: () => import('@/views/admin/UserManager.vue') },
      ],
    },
    {
      path: '/user',
      ...
      children: [
        ...
        { path: 'coach', name: 'coach', meta: { title: '金牌教练' }, component: () => import('@/views/user/Coach.vue') },
        ...
        { path: 'cookbook', name: 'cookbook', meta: { title: '健身菜谱' }, component: () => import('@/views/user/CookBook.vue') },
        { path: 'experience', name: 'experience', meta: { title: '经验分享' }, component: () => import('@/views/user/Experience.vue') },
        ...
        { path: 'experienceDetails/:id', name: 'experienceDetails', meta: { title: '经验详情' }, component: () => import('@/views/user/ExperienceDetails.vue') },
...
router.beforeEach(async (to, from, next) => {
  if (to.name !== 'login' && localStorage.getItem('userInfo') === null) next({ name: 'login' })
  else next()
})
